:menu
@echo off & color 0f & cls & title start.bat creer par Demon-Galaxy
mode 60,20
color 0c
echo.
...
echo.
cd /d D:\ReversideRP
D:\ReversideRP\FXServer.exe +exec server.cfg
echo.
...
XCOPY D:\ReversideRP D:\ReversideRP-backup\ /m /e /y
echo.
